 ...
 */
	...
	*/
	...
	public class LUDecompositionFloat{
	...
	*/	
	public LUDecompositionFloat (MatrixFloat A) {
	...
	*/
	...
	public MatrixFloat getU () {
	   MatrixFloat X = new MatrixFloat(n,n);
	   float[][] U = X.getArray();
	   for (int i = 0; i < n; i++) {
	      for (int j = 0; j < n; j++) {
	         if (i <= j) {
	...
	*/
	...
	public MatrixFloat solve (MatrixFloat B) {
	   ...
	   MatrixFloat Xmat = B.getMatrix(piv,0,nx-1);
